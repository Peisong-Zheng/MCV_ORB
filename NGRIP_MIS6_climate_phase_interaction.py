#!/usr/bin/env python3
"""Continuous LR04 modulation of precession in the primary NGRIP_MIS6 catalogue."""
...
AGE_INPUT = ROOT / "data/processed/NGRIP_MIS6_orbital_driver_sensitivity/selected_realizations.csv"
